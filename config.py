...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "7464406395:AAGh1wS4f3p37S1AaPd0BgO-0P2mum2ykus")
...
#Your db channel Id
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002247144037"))
...
try:
    ADMINS=[]
    for x in (os.environ.get("ADMINS", "7258325900,1709824863").split()):
        ADMINS.append(int(x))
except ValueError:
